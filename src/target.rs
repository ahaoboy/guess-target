...
pub enum Os {
Darwin,Linux,Windows,Freebsd,Illumos,Netbsd
}
impl Os {
...
#[derive(Debug, PartialEq, Clone, Copy)]
pub enum Arch {
Aarch64,I686,X86_64,Arm,Armv7,Loongarch64,Powerpc,Powerpc64,Powerpc64le,Riscv64gc,S390x
}
impl Arch {
    pub fn to_str(&self)->&'static str {
    match self {
...
pub const VENDOR_LIST : [Vendor; 3] = [
Vendor::Apple,
Vendor::Unknown,
Vendor::Pc
];
...
#[derive(Debug, PartialEq, Clone, Copy)]
pub enum Abi {
Gnu,Msvc,Musl,Gnueabi,Gnueabihf
}
impl Abi {
    pub fn to_str(&self)->&'static str {
    match self {
...
#[derive(Debug, PartialEq, Clone, Copy)]
pub enum Target {
Aarch64AppleDarwin,Aarch64UnknownLinuxGnu,I686PcWindowsGnu,I686PcWindowsMsvc,I686UnknownLinuxGnu,X86_64AppleDarwin,X86_64PcWindowsGnu,X86_64PcWindowsMsvc,X86_64UnknownLinuxGnu,Aarch64PcWindowsMsvc,Aarch64UnknownLinuxMusl,ArmUnknownLinuxGnueabi,ArmUnknownLinuxGnueabihf,Armv7UnknownLinuxGnueabihf,Loongarch64UnknownLinuxGnu,Loongarch64UnknownLinuxMusl,PowerpcUnknownLinuxGnu,Powerpc64UnknownLinuxGnu,Powerpc64leUnknownLinuxGnu,Powerpc64leUnknownLinuxMusl,Riscv64gcUnknownLinuxGnu,Riscv64gcUnknownLinuxMusl,S390xUnknownLinuxGnu,X86_64UnknownFreebsd,X86_64UnknownIllumos,X86_64UnknownLinuxMusl,X86_64UnknownNetbsd
}
impl Target {
    pub fn to_str(&self)->&'static str {
    match self {
...
pub const DEFAULT_RULE: [(Target, Arch, Vendor, Os, Option<Abi>);27] = [( Target::Aarch64AppleDarwin,Arch::Aarch64,Vendor::Apple,Os::Darwin,None),
( Target::Aarch64UnknownLinuxGnu,Arch::Aarch64,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::I686PcWindowsGnu,Arch::I686,Vendor::Pc,Os::Windows,Some(Abi::Gnu)),
( Target::I686PcWindowsMsvc,Arch::I686,Vendor::Pc,Os::Windows,Some(Abi::Msvc)),
( Target::I686UnknownLinuxGnu,Arch::I686,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::X86_64AppleDarwin,Arch::X86_64,Vendor::Apple,Os::Darwin,None),
( Target::X86_64PcWindowsGnu,Arch::X86_64,Vendor::Pc,Os::Windows,Some(Abi::Gnu)),
( Target::X86_64PcWindowsMsvc,Arch::X86_64,Vendor::Pc,Os::Windows,Some(Abi::Msvc)),
( Target::X86_64UnknownLinuxGnu,Arch::X86_64,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::Aarch64PcWindowsMsvc,Arch::Aarch64,Vendor::Pc,Os::Windows,Some(Abi::Msvc)),
( Target::Aarch64UnknownLinuxMusl,Arch::Aarch64,Vendor::Unknown,Os::Linux,Some(Abi::Musl)),
( Target::ArmUnknownLinuxGnueabi,Arch::Arm,Vendor::Unknown,Os::Linux,Some(Abi::Gnueabi)),
( Target::ArmUnknownLinuxGnueabihf,Arch::Arm,Vendor::Unknown,Os::Linux,Some(Abi::Gnueabihf)),
( Target::Armv7UnknownLinuxGnueabihf,Arch::Armv7,Vendor::Unknown,Os::Linux,Some(Abi::Gnueabihf)),
( Target::Loongarch64UnknownLinuxGnu,Arch::Loongarch64,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::Loongarch64UnknownLinuxMusl,Arch::Loongarch64,Vendor::Unknown,Os::Linux,Some(Abi::Musl)),
( Target::PowerpcUnknownLinuxGnu,Arch::Powerpc,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::Powerpc64UnknownLinuxGnu,Arch::Powerpc64,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::Powerpc64leUnknownLinuxGnu,Arch::Powerpc64le,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::Powerpc64leUnknownLinuxMusl,Arch::Powerpc64le,Vendor::Unknown,Os::Linux,Some(Abi::Musl)),
( Target::Riscv64gcUnknownLinuxGnu,Arch::Riscv64gc,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::Riscv64gcUnknownLinuxMusl,Arch::Riscv64gc,Vendor::Unknown,Os::Linux,Some(Abi::Musl)),
( Target::S390xUnknownLinuxGnu,Arch::S390x,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::X86_64UnknownFreebsd,Arch::X86_64,Vendor::Unknown,Os::Freebsd,None),
( Target::X86_64UnknownIllumos,Arch::X86_64,Vendor::Unknown,Os::Illumos,None),
( Target::X86_64UnknownLinuxMusl,Arch::X86_64,Vendor::Unknown,Os::Linux,Some(Abi::Musl)),
( Target::X86_64UnknownNetbsd,Arch::X86_64,Vendor::Unknown,Os::Netbsd,None)];