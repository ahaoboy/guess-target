...
pub enum Os {
Darwin,Linux,Windows,Freebsd,Illumos,Netbsd,Ios,Android,Fuchsia,None,Uefi,Androideabi,Eabi,Eabihf,Cuda,Solaris,Emscripten,Unknown,Wasip1,Threads,Wasip2,Redox
}
impl Os {
...
#[derive(EnumIter, Debug, PartialEq, Clone, Copy)]
pub enum Arch {
Aarch64,I686,X86_64,Arm,Armv7,Loongarch64,Powerpc,Powerpc64,Powerpc64le,Riscv64gc,S390x,Arm64ec,Armebv7r,Armv5te,Armv7a,Armv7r,I586,Nvptx64,Riscv32i,Riscv32im,Riscv32imac,Riscv32imafc,Riscv32imc,Riscv64imac,Sparc64,Sparcv9,Thumbv6m,Thumbv7em,Thumbv7m,Thumbv7neon,Thumbv8mBase,Thumbv8mMain,Wasm32,Wasm32v1
}
impl Arch {
    pub fn to_str(&self)->&'static str {
    match self {
...
#[derive(EnumIter, Debug, PartialEq, Clone, Copy)]
pub enum Vendor {
Apple,Unknown,Pc,Linux,None,Nvidia,Sun,Wasip1,Wasip2,Fortanix
}
impl Vendor {
    pub fn to_str(&self)->&'static str {
    match self {
...
#[derive(EnumIter, Debug, PartialEq, Clone, Copy)]
pub enum Abi {
Gnu,Msvc,Musl,Gnueabi,Gnueabihf,Macabi,Sim,Gnullvm,Ohos,Softfloat,Musleabi,Musleabihf,Elf,Sgx,Gnux32
}
impl Abi {
    pub fn to_str(&self)->&'static str {
    match self {
...
#[derive(EnumIter, Debug, PartialEq, Clone, Copy)]
pub enum Target {
Aarch64AppleDarwin,Aarch64UnknownLinuxGnu,I686PcWindowsGnu,I686PcWindowsMsvc,I686UnknownLinuxGnu,X86_64AppleDarwin,X86_64PcWindowsGnu,X86_64PcWindowsMsvc,X86_64UnknownLinuxGnu,Aarch64PcWindowsMsvc,Aarch64UnknownLinuxMusl,ArmUnknownLinuxGnueabi,ArmUnknownLinuxGnueabihf,Armv7UnknownLinuxGnueabihf,Loongarch64UnknownLinuxGnu,Loongarch64UnknownLinuxMusl,PowerpcUnknownLinuxGnu,Powerpc64UnknownLinuxGnu,Powerpc64leUnknownLinuxGnu,Powerpc64leUnknownLinuxMusl,Riscv64gcUnknownLinuxGnu,Riscv64gcUnknownLinuxMusl,S390xUnknownLinuxGnu,X86_64UnknownFreebsd,X86_64UnknownIllumos,X86_64UnknownLinuxMusl,X86_64UnknownNetbsd,Aarch64AppleIos,Aarch64AppleIosMacabi,Aarch64AppleIosSim,Aarch64LinuxAndroid,Aarch64PcWindowsGnullvm,Aarch64UnknownFuchsia,Aarch64UnknownLinuxOhos,Aarch64UnknownNone,Aarch64UnknownNoneSoftfloat,Aarch64UnknownUefi,ArmLinuxAndroideabi,ArmUnknownLinuxMusleabi,ArmUnknownLinuxMusleabihf,Arm64ecPcWindowsMsvc,Armebv7rNoneEabi,Armebv7rNoneEabihf,Armv5teUnknownLinuxGnueabi,Armv5teUnknownLinuxMusleabi,Armv7LinuxAndroideabi,Armv7UnknownLinuxGnueabi,Armv7UnknownLinuxMusleabi,Armv7UnknownLinuxMusleabihf,Armv7UnknownLinuxOhos,Armv7aNoneEabi,Armv7rNoneEabi,Armv7rNoneEabihf,I586PcWindowsMsvc,I586UnknownLinuxGnu,I586UnknownLinuxMusl,I686LinuxAndroid,I686PcWindowsGnullvm,I686UnknownFreebsd,I686UnknownLinuxMusl,I686UnknownUefi,Loongarch64UnknownNone,Loongarch64UnknownNoneSoftfloat,Nvptx64NvidiaCuda,Riscv32iUnknownNoneElf,Riscv32imUnknownNoneElf,Riscv32imacUnknownNoneElf,Riscv32imafcUnknownNoneElf,Riscv32imcUnknownNoneElf,Riscv64gcUnknownNoneElf,Riscv64imacUnknownNoneElf,Sparc64UnknownLinuxGnu,Sparcv9SunSolaris,Thumbv6mNoneEabi,Thumbv7emNoneEabi,Thumbv7emNoneEabihf,Thumbv7mNoneEabi,Thumbv7neonLinuxAndroideabi,Thumbv7neonUnknownLinuxGnueabihf,Thumbv8mBaseNoneEabi,Thumbv8mMainNoneEabi,Thumbv8mMainNoneEabihf,Wasm32UnknownEmscripten,Wasm32UnknownUnknown,Wasm32Wasip1,Wasm32Wasip1Threads,Wasm32Wasip2,Wasm32v1None,X86_64AppleIos,X86_64AppleIosMacabi,X86_64FortanixUnknownSgx,X86_64LinuxAndroid,X86_64PcSolaris,X86_64PcWindowsGnullvm,X86_64UnknownFuchsia,X86_64UnknownLinuxGnux32,X86_64UnknownLinuxOhos,X86_64UnknownNone,X86_64UnknownRedox,X86_64UnknownUefi
}
impl Target {
    pub fn to_str(&self)->&'static str {
    match self {
...
pub const DEFAULT_RULE: [(Target, Arch, Vendor, Os, Option<Abi>);100] = [( Target::Aarch64AppleDarwin,Arch::Aarch64,Vendor::Apple,Os::Darwin,None),
...
( Target::Aarch64AppleIos,Arch::Aarch64,Vendor::Apple,Os::Ios,None),
( Target::Aarch64AppleIosMacabi,Arch::Aarch64,Vendor::Apple,Os::Ios,Some(Abi::Macabi)),
( Target::Aarch64AppleIosSim,Arch::Aarch64,Vendor::Apple,Os::Ios,Some(Abi::Sim)),
( Target::Aarch64LinuxAndroid,Arch::Aarch64,Vendor::Linux,Os::Android,None),
( Target::Aarch64PcWindowsGnullvm,Arch::Aarch64,Vendor::Pc,Os::Windows,Some(Abi::Gnullvm)),
( Target::Aarch64UnknownFuchsia,Arch::Aarch64,Vendor::Unknown,Os::Fuchsia,None),
( Target::Aarch64UnknownLinuxOhos,Arch::Aarch64,Vendor::Unknown,Os::Linux,Some(Abi::Ohos)),
( Target::Aarch64UnknownNone,Arch::Aarch64,Vendor::Unknown,Os::None,None),
( Target::Aarch64UnknownNoneSoftfloat,Arch::Aarch64,Vendor::Unknown,Os::None,Some(Abi::Softfloat)),
( Target::Aarch64UnknownUefi,Arch::Aarch64,Vendor::Unknown,Os::Uefi,None),
( Target::ArmLinuxAndroideabi,Arch::Arm,Vendor::Linux,Os::Androideabi,None),
( Target::ArmUnknownLinuxMusleabi,Arch::Arm,Vendor::Unknown,Os::Linux,Some(Abi::Musleabi)),
( Target::ArmUnknownLinuxMusleabihf,Arch::Arm,Vendor::Unknown,Os::Linux,Some(Abi::Musleabihf)),
( Target::Arm64ecPcWindowsMsvc,Arch::Arm64ec,Vendor::Pc,Os::Windows,Some(Abi::Msvc)),
( Target::Armebv7rNoneEabi,Arch::Armebv7r,Vendor::None,Os::Eabi,None),
( Target::Armebv7rNoneEabihf,Arch::Armebv7r,Vendor::None,Os::Eabihf,None),
( Target::Armv5teUnknownLinuxGnueabi,Arch::Armv5te,Vendor::Unknown,Os::Linux,Some(Abi::Gnueabi)),
( Target::Armv5teUnknownLinuxMusleabi,Arch::Armv5te,Vendor::Unknown,Os::Linux,Some(Abi::Musleabi)),
( Target::Armv7LinuxAndroideabi,Arch::Armv7,Vendor::Linux,Os::Androideabi,None),
( Target::Armv7UnknownLinuxGnueabi,Arch::Armv7,Vendor::Unknown,Os::Linux,Some(Abi::Gnueabi)),
( Target::Armv7UnknownLinuxMusleabi,Arch::Armv7,Vendor::Unknown,Os::Linux,Some(Abi::Musleabi)),
( Target::Armv7UnknownLinuxMusleabihf,Arch::Armv7,Vendor::Unknown,Os::Linux,Some(Abi::Musleabihf)),
( Target::Armv7UnknownLinuxOhos,Arch::Armv7,Vendor::Unknown,Os::Linux,Some(Abi::Ohos)),
( Target::Armv7aNoneEabi,Arch::Armv7a,Vendor::None,Os::Eabi,None),
( Target::Armv7rNoneEabi,Arch::Armv7r,Vendor::None,Os::Eabi,None),
( Target::Armv7rNoneEabihf,Arch::Armv7r,Vendor::None,Os::Eabihf,None),
( Target::I586PcWindowsMsvc,Arch::I586,Vendor::Pc,Os::Windows,Some(Abi::Msvc)),
( Target::I586UnknownLinuxGnu,Arch::I586,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::I586UnknownLinuxMusl,Arch::I586,Vendor::Unknown,Os::Linux,Some(Abi::Musl)),
( Target::I686LinuxAndroid,Arch::I686,Vendor::Linux,Os::Android,None),
( Target::I686PcWindowsGnullvm,Arch::I686,Vendor::Pc,Os::Windows,Some(Abi::Gnullvm)),
( Target::I686UnknownFreebsd,Arch::I686,Vendor::Unknown,Os::Freebsd,None),
( Target::I686UnknownLinuxMusl,Arch::I686,Vendor::Unknown,Os::Linux,Some(Abi::Musl)),
( Target::I686UnknownUefi,Arch::I686,Vendor::Unknown,Os::Uefi,None),
( Target::Loongarch64UnknownNone,Arch::Loongarch64,Vendor::Unknown,Os::None,None),
( Target::Loongarch64UnknownNoneSoftfloat,Arch::Loongarch64,Vendor::Unknown,Os::None,Some(Abi::Softfloat)),
( Target::Nvptx64NvidiaCuda,Arch::Nvptx64,Vendor::Nvidia,Os::Cuda,None),
( Target::Riscv32iUnknownNoneElf,Arch::Riscv32i,Vendor::Unknown,Os::None,Some(Abi::Elf)),
( Target::Riscv32imUnknownNoneElf,Arch::Riscv32im,Vendor::Unknown,Os::None,Some(Abi::Elf)),
( Target::Riscv32imacUnknownNoneElf,Arch::Riscv32imac,Vendor::Unknown,Os::None,Some(Abi::Elf)),
( Target::Riscv32imafcUnknownNoneElf,Arch::Riscv32imafc,Vendor::Unknown,Os::None,Some(Abi::Elf)),
( Target::Riscv32imcUnknownNoneElf,Arch::Riscv32imc,Vendor::Unknown,Os::None,Some(Abi::Elf)),
( Target::Riscv64gcUnknownNoneElf,Arch::Riscv64gc,Vendor::Unknown,Os::None,Some(Abi::Elf)),
( Target::Riscv64imacUnknownNoneElf,Arch::Riscv64imac,Vendor::Unknown,Os::None,Some(Abi::Elf)),
( Target::Sparc64UnknownLinuxGnu,Arch::Sparc64,Vendor::Unknown,Os::Linux,Some(Abi::Gnu)),
( Target::Sparcv9SunSolaris,Arch::Sparcv9,Vendor::Sun,Os::Solaris,None),
( Target::Thumbv6mNoneEabi,Arch::Thumbv6m,Vendor::None,Os::Eabi,None),
( Target::Thumbv7emNoneEabi,Arch::Thumbv7em,Vendor::None,Os::Eabi,None),
( Target::Thumbv7emNoneEabihf,Arch::Thumbv7em,Vendor::None,Os::Eabihf,None),
( Target::Thumbv7mNoneEabi,Arch::Thumbv7m,Vendor::None,Os::Eabi,None),
( Target::Thumbv7neonLinuxAndroideabi,Arch::Thumbv7neon,Vendor::Linux,Os::Androideabi,None),
( Target::Thumbv7neonUnknownLinuxGnueabihf,Arch::Thumbv7neon,Vendor::Unknown,Os::Linux,Some(Abi::Gnueabihf)),
( Target::Thumbv8mBaseNoneEabi,Arch::Thumbv8mBase,Vendor::None,Os::Eabi,None),
( Target::Thumbv8mMainNoneEabi,Arch::Thumbv8mMain,Vendor::None,Os::Eabi,None),
( Target::Thumbv8mMainNoneEabihf,Arch::Thumbv8mMain,Vendor::None,Os::Eabihf,None),
( Target::Wasm32UnknownEmscripten,Arch::Wasm32,Vendor::Unknown,Os::Emscripten,None),
( Target::Wasm32UnknownUnknown,Arch::Wasm32,Vendor::Unknown,Os::Unknown,None),
( Target::Wasm32Wasip1,Arch::Wasm32,Vendor::Wasip1,Os::Wasip1,None),
( Target::Wasm32Wasip1Threads,Arch::Wasm32,Vendor::Wasip1,Os::Threads,None),
( Target::Wasm32Wasip2,Arch::Wasm32,Vendor::Wasip2,Os::Wasip2,None),
( Target::Wasm32v1None,Arch::Wasm32v1,Vendor::None,Os::None,None),
( Target::X86_64AppleIos,Arch::X86_64,Vendor::Apple,Os::Ios,None),
( Target::X86_64AppleIosMacabi,Arch::X86_64,Vendor::Apple,Os::Ios,Some(Abi::Macabi)),
( Target::X86_64FortanixUnknownSgx,Arch::X86_64,Vendor::Fortanix,Os::Unknown,Some(Abi::Sgx)),
( Target::X86_64LinuxAndroid,Arch::X86_64,Vendor::Linux,Os::Android,None),
( Target::X86_64PcSolaris,Arch::X86_64,Vendor::Pc,Os::Solaris,None),
( Target::X86_64PcWindowsGnullvm,Arch::X86_64,Vendor::Pc,Os::Windows,Some(Abi::Gnullvm)),
( Target::X86_64UnknownFuchsia,Arch::X86_64,Vendor::Unknown,Os::Fuchsia,None),
( Target::X86_64UnknownLinuxGnux32,Arch::X86_64,Vendor::Unknown,Os::Linux,Some(Abi::Gnux32)),
( Target::X86_64UnknownLinuxOhos,Arch::X86_64,Vendor::Unknown,Os::Linux,Some(Abi::Ohos)),
( Target::X86_64UnknownNone,Arch::X86_64,Vendor::Unknown,Os::None,None),
( Target::X86_64UnknownRedox,Arch::X86_64,Vendor::Unknown,Os::Redox,None),
( Target::X86_64UnknownUefi,Arch::X86_64,Vendor::Unknown,Os::Uefi,None)];