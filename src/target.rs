...
pub const VENDOR_LIST: [Vendor; 10] = [
    Vendor::Apple,
    Vendor::Unknown,
    Vendor::Pc,
    Vendor::Linux,
...
pub const TARGET_LIST: [Target; 100] = [
    ...
    Target::Aarch64AppleIos,
    Target::Aarch64AppleIosMacabi,
    Target::Aarch64AppleIosSim,
    Target::Aarch64LinuxAndroid,
    Target::Aarch64PcWindowsGnullvm,
    Target::Aarch64UnknownFuchsia,
    Target::Aarch64UnknownLinuxOhos,
    Target::Aarch64UnknownNone,
    Target::Aarch64UnknownNoneSoftfloat,
    Target::Aarch64UnknownUefi,
    Target::ArmLinuxAndroideabi,
    Target::ArmUnknownLinuxMusleabi,
    Target::ArmUnknownLinuxMusleabihf,
    Target::Arm64ecPcWindowsMsvc,
    Target::Armebv7rNoneEabi,
    Target::Armebv7rNoneEabihf,
    Target::Armv5teUnknownLinuxGnueabi,
    Target::Armv5teUnknownLinuxMusleabi,
    Target::Armv7LinuxAndroideabi,
    Target::Armv7UnknownLinuxGnueabi,
    Target::Armv7UnknownLinuxMusleabi,
    Target::Armv7UnknownLinuxMusleabihf,
    Target::Armv7UnknownLinuxOhos,
    Target::Armv7aNoneEabi,
    Target::Armv7rNoneEabi,
    Target::Armv7rNoneEabihf,
    Target::I586PcWindowsMsvc,
    Target::I586UnknownLinuxGnu,
    Target::I586UnknownLinuxMusl,
    Target::I686LinuxAndroid,
    Target::I686PcWindowsGnullvm,
    Target::I686UnknownFreebsd,
    Target::I686UnknownLinuxMusl,
    Target::I686UnknownUefi,
    Target::Loongarch64UnknownNone,
    Target::Loongarch64UnknownNoneSoftfloat,
    Target::Nvptx64NvidiaCuda,
    Target::Riscv32iUnknownNoneElf,
    Target::Riscv32imUnknownNoneElf,
    Target::Riscv32imacUnknownNoneElf,
    Target::Riscv32imafcUnknownNoneElf,
    Target::Riscv32imcUnknownNoneElf,
    Target::Riscv64gcUnknownNoneElf,
    Target::Riscv64imacUnknownNoneElf,
    ...
    Target::Thumbv7neonLinuxAndroideabi,
...
pub const DEFAULT_RULE: [(Target, Arch, Vendor, Os, Option<Abi>); 100] = [
    (
        Target::Aarch64AppleDarwin,
        Arch::Aarch64,
        Vendor::Apple,
